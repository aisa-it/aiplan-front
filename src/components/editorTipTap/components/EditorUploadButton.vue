<template>
  <v-btn icon variant="text" size="small" density="compact" @click="onImageUpload">
...
import { notSupportableFormat } from '../utils/tiptap';
// TODO: notification-store — not migrated yet
