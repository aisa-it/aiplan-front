...
export const getEditorExtensions = (props: Record<string, any>) => {
  ...
  // TODO: special link mentions — disabled until utils migrated
  ...
  if (props.showHeadings) {
    extensions.push(
      ...
      // TODO: TableOfContentsCustom — disabled until utils migrated
