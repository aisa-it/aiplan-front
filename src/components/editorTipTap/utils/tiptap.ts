...
// TODO: ensure @tiptap/extension-list-item is installed; used by ListItemExtend
...
// TODO: links utils — not migrated yet
// import {
//   parseCommentLink,
//   parseIssueLink,
//   parseAttachmentLink,
// } from '../../../utils/links';
const parseCommentLink = (_text?: string | null) => null;
const parseIssueLink = (_text?: string | null) => null;
const parseAttachmentLink = (_text?: string | null) => null;
...
const setNotificationView = (_payload: unknown) => {
  // TODO: restore once notification-store is migrated
};
const ERROR_FORMAT_FILE = 'Неподдерживаемый формат файла';

import { EditorView } from '@tiptap/pm/view';

import type { DtoProjectMemberLight } from '@aisa-it/aiplan-api-ts/src/data-contracts';
